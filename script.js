...
var t = "TE AMO".split("").join(String.fromCharCode(0x2006));
$.fillText(t, (c.width - $.measureText(t).width) * 0.5, c.height * 0.35); // Moved up slightly

// Adding "MAMIET" below
$.font = "Bold 8em sans-serif"; // Increased font size
var t2 = "MAMIET".split("").join(String.fromCharCode(0x2006));
$.fillText(t2, (c.width - $.measureText(t2).width) * 0.5, c.height * 0.55); // Position it below "Te AMO"
